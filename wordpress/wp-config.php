...
define( 'WPCACHEHOME', '/Users/paula/www/cocalecatours/wordpress/wp-content/plugins/wp-super-cache/' ); //Added by WP-Cache Manager
define('DB_NAME', 'lizegama_wp1');

/** MySQL database username */
//define('DB_USER', 'lizegama_wp1');
define('DB_USER', 'root');

/** MySQL database password */
//define('DB_PASSWORD', 'G&lP8B4M&D((Ajvc[7@28.^1');
